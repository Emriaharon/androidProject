...
public class Model {
    ...
    private Executor exacutors_single_thread = Executors.newSingleThreadExecutor();
    ...
    public FirebaseAuth getAuth() {
        return firebaseModel.autantichation;
    }
    ...
    public FirebaseFirestore getDb() {
        return firebaseModel.getDatabasefirestore();
    }
